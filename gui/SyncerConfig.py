...
class SyncerConfig:
    def __init__(self):
        ...
        self.mappings_list = {'mappings': [{'from': 'pramanan3/test_scarlets', 'to': 'test_scarlets', 'tags': ['latest']}, {'from': 'blockalytics/blockalytics_node', 'to': 'blockalytics_node', 'tags': ['latest']}, {'from': 'blockalytics/regressor', 'to': 'regressor', 'tags': ['latest']}, {'from': 'blockalytics/ipfs_node', 'to': 'ipfs_node', 'tags': ['latest']}]}
        ...
        with st.container():
            ...
            with save_config:
                ...
                if st.session_state.syncer_save_config_clicked:
                    global_platform_env_file_str = self.save_params("mappings_list")
                    st.session_state.syncer_save_config_clicked = False
            ...
            with download_config:
                ...
                st.download_button(
                    ...
                    data=self.save_params("mappings_list"),
