...
def sidebarInit():
    ...
    logo_url = os.path.join(parent,"images","gustavo_scaled_transparent.png")
    ...
    with st.sidebar:
        ...
        if str(os.getenv("AUTH_ENABLED", "false")).lower() in ("1", "true", "yes", "on") or st.session_state.get("AUTH_ENABLED"):
            # Small logout button
