...
import datetime # Added for timestamping backups
    ...
    * `syncer`
    ...
    def create_redis_backup(self):
        ...
        try:
            ...
            # Execute BGSAVE command inside the Redis container
            exec_result = redis_container.exec_run("redis-cli BGSAVE")
    ...
    def delete_redis_backup(self, filename):
    ...
    def list_registry_backups(self):
        try:
            ...
            dirs = [d for d in os.listdir(self.REGISTRY_BKP_DIR) if os.path.isdir(os.path.join(self.REGISTRY_BKP_DIR, d)) and d.startswith("registry_backup_")]
            backups = []
            for d in dirs:
    ...
    def delete_registry_backup(self, dirname):
